...
public class MapActivity extends FragmentActivity implements OnMapReadyCallback {
    ...
    private String keyapi = "AIzaSyBlw_dMVWjZf2OyeldB5vcb7EyhtDjRdZY";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Intent t = getIntent();
        postModel = (PostModel) t.getSerializableExtra("SelectedAdd");
        try {
            getLocationFromAddress(postModel.getFullAddress());
        } catch (IOException e) {
            e.printStackTrace();
        }
...
//        fetchLocation();
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        MarkerOptions markerOptions2 = new MarkerOptions().position(latLng2).title("Destination location");
    ...
    private String getDirectionsUrl(LatLng origin, LatLng dest) {
        ...
        String key = "key=AIzaSyBlw_dMVWjZf2OyeldB5vcb7EyhtDjRdZY";
