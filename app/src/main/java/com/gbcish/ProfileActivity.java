...
public class ProfileActivity extends AppCompatActivity {
    ...
    String TAG = " camera";
    File photoFile;final int TAKE_PHOTO_ACTIVITY_REQUEST_CODE = 1600;
...
//                    startActivity(i);
                                                                                ...
                                                                                profiledatatwo();
                                                                                showAlert("Alert","Profile Updated");
                                ...
                                if (propic.equals("0")){
                                    ...
                                    islandRef.getBytes(Long.MAX_VALUE).addOnSuccessListener(new OnSuccessListener<byte[]>() {
                                        ...
                                        public void onFailure(@NonNull Exception exception) {
                                            // Handle any errors
                                            progressDialog.dismiss();
                                            showAlert("Alert","Can't load profile pic");
        ...
        new AlertDialog.Builder(ProfileActivity.this)
                ...
                .setNegativeButton("Camera", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        ...
                        Uri fileProvider = FileProvider.getUriForFile(ProfileActivity.this, "com.example.internationalstudenthelper", photoFile);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == TAKE_PHOTO_ACTIVITY_REQUEST_CODE) {
            if (resultCode == RESULT_OK) {
                ...
                showAlert("Alert","Not able to take photo");
